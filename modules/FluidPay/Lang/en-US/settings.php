...
return [
    ...
    'sections' => [
        'credentials' => [
            ...
            'description' => 'Provide your FluidPay API credentials to enable tokenization and secure payment processing.',
        ],
        'invoice' => [
            'title' => 'Invoice Tokenizer',
            'description' => 'Control the fields and payment methods customers see when paying invoices.',
        ],
        'retainer' => [
            'title' => 'Retainer Tokenizer',
    ...
    'help' => [
        'credentials' => 'Generate API keys in your FluidPay dashboard. Keep your private key secure; only your public key is required for the tokenizer.',
    ],
